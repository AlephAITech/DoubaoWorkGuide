...
import { renderMarkdown, escapeHtml, plainText } from "./markdown.js?v=20260912-analytics-2";
...
const ASSET_VERSION =
  document.querySelector('meta[name="dwg-assets-version"]')?.content || "20260912-analytics-2";
